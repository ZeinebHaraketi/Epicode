...
public class Afficher_CommentaireController implements Initializable {
    ...
    @FXML
    private void Date_occ(KeyEvent event) throws SQLException {
...
Stage stage;
    ...
    @FXML
    private void exit_com(ActionEvent event) {
   ...
   private volatile boolean stop = false;
    ...
    @FXML
    private void stat_com(ActionEvent event) {
        try {
                   
            Parent parent = FXMLLoader.load(getClass().getResource("/GUI/comment_stat.fxml"));
    ...
    @FXML
    private void mail_com(ActionEvent event) {
    }
    }
