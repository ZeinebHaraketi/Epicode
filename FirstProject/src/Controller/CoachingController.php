...
class CoachingController extends AbstractController
{
    ...
    /**
     * @Route("/{idS}", name="app_coaching_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idS}/edit", name="app_coaching_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{idS}", name="app_coaching_delete", methods={"POST"})
     */
    public function delete(Request $request, Coaching $coaching, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$coaching->getIdS(), $request->request->get('_token'))) {
